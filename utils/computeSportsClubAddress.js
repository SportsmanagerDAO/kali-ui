...
export const computeSportsClubAddress = (name, chainId) => {
  const sportsClubMaster = addresses[chainId]['sportsClubMaster']
  ...
  const bytecodeHash = ethers.utils.keccak256(
    ethers.utils.solidityPack(
      ...
      ['0x3d602d80600a3d3981f3', '0x363d3d373d3d3d363d73', sportsClubMaster, '0x5af43d82803e903d91602b57fd5bf3'],
    ),
  )
